...
export default class View extends PureComponent {
  ...
  render () {
     ...
     */
    // const reduxModule = getHackerNewsModule()
    // react hot load多次调用的最后两次才能访问到新的reduxModule
    // ，这里影响到了DynamicModuleLoader工作
    return this.state.readyToRender === true ? <DynamicModuleLoader strictMode={true} modules={[getHackerNewsModule()]}>
      <ConnectedHackerNews />
